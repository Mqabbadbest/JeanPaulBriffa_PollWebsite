...
{
    /// <inheritdoc />
    public partial class FirstMigration_ModelsAndIdentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Option3Text = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Option3VotesCount = table.Column<int>(type: "int", nullable: true),
